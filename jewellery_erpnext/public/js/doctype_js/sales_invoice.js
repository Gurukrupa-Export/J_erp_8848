...
frappe.ui.form.on('Sales Invoice Item', {
    serial_no(frm, cdt, cdn) {
        ...
        if (child.serial_no) {
            frappe.db.get_value('BOM', { 'tag_no': child.serial_no, 'is_active': 1, 'customer': frm.doc.customer }, 'name')
                .then((r) => {
                    if (r.message.name) {
    ...
    custom_edit_bom: function (frm, cdt, cdn) {
        ...
        const metal_fields = [
            ...
            { fieldtype: 'Link', fieldname: "metal_type", label: __('Metal Type'), reqd: 1, read_only: 1, columns: 1, reqd: 1, in_list_view: 1, options: "Attribute Value", get_query() { return { query: 'jewellery_erpnext.query.item_attribute_query', filters: { 'item_attribute': 'Metal Type' } } } },
            { fieldtype: 'Link', fieldname: "metal_touch", label: __('Metal Touch'), reqd: 1, read_only: 1, columns: 1, in_list_view: 1, options: "Attribute Value", get_query() { return { query: 'jewellery_erpnext.query.item_attribute_query', filters: { 'item_attribute': 'Metal Touch' } } } },
            { fieldtype: 'Link', fieldname: "metal_purity", label: __('Metal Purity'), reqd: 1, read_only: 1, columns: 1, in_list_view: 1, options: "Attribute Value", get_query() { return { query: 'jewellery_erpnext.query.item_attribute_query', filters: { 'item_attribute': 'Metal Purity' } } } },
            { fieldtype: 'Link', fieldname: "metal_colour", label: __('Metal Colour'), reqd: 1, read_only: 1, columns: 1, in_list_view: 1, options: "Attribute Value", get_query() { return { query: 'jewellery_erpnext.query.item_attribute_query', filters: { 'item_attribute': 'Metal Colour' } } } },
            { fieldtype: 'Column Break', fieldname: 'clb1' },
            { fieldtype: 'Float', fieldname: "quantity", label: __('Weight In Gms'), reqd: 1, read_only: 1, columns: 1, in_list_view: 1 },
            { fieldtype: 'Float', fieldname: "rate", label: __('Gold Rate'), reqd: 1, columns: 1, in_list_view: 1 },
            { fieldtype: 'Float', fieldname: "amount", label: __('Gold Amount'), reqd: 1, read_only: 1, columns: 1, in_list_view: 1 },
            ...
            { fieldtype: 'Float', fieldname: "making_amount", label: __('Making Amount'), read_only: 1, reqd: 1, columns: 1, in_list_view: 1 },
            { fieldtype: 'Float', fieldname: "wastage_rate", label: __('Wastage Rate'), columns: 1 },
            { fieldtype: 'Float', fieldname: "wastage_amount", label: __('Wastage Amount'), columns: 1, read_only: 1, in_list_view: 1 },
        ];

        const diamond_fields = [
            { fieldtype: 'Data', fieldname: "docname", read_only: 1, hidden: 1 },
            { fieldtype: 'Link', fieldname: "diamond_type", label: __('Diamond Type'), columns: 1, reqd: 1, read_only: 1, in_list_view: 1, options: "Attribute Value", get_query() { return { query: 'jewellery_erpnext.query.item_attribute_query', filters: { 'item_attribute': 'Diamond Type' } } } },
            { fieldtype: 'Link', fieldname: "stone_shape", label: __('Stone Shape'), columns: 1, read_only: 1, reqd: 1, in_list_view: 1, options: "Attribute Value", get_query() { return { query: 'jewellery_erpnext.query.item_attribute_query', filters: { 'item_attribute': 'Stone Shape' } } } },
            { fieldtype: 'Link', fieldname: "diamond_cut", label: __('Diamond Cut'), columns: 1, read_only: 1, reqd: 1, options: "Attribute Value", get_query() { return { query: 'jewellery_erpnext.query.item_attribute_query', filters: { 'item_attribute': 'Stone Shape' } } } },
            { fieldtype: 'Link', fieldname: "quality", label: __('Diamond Quality'), columns: 1, read_only: 1, reqd: 1, in_list_view: 1, options: "Attribute Value", get_query() { return { query: 'jewellery_erpnext.query.item_attribute_query', filters: { 'item_attribute': 'Diamond Quality' } } } },
            { fieldtype: 'Column Break', fieldname: 'clb1' },
            { fieldtype: 'Link', fieldname: "sub_setting_type", label: __('Sub Setting Type'), read_only: 1, columns: 1, reqd: 1, options: "Attribute Value", get_query() { return { query: 'jewellery_erpnext.query.item_attribute_query', filters: { 'item_attribute': 'Sub Setting Type' } } } },
            { fieldtype: 'Link', fieldname: "diamond_sieve_size", label: __('Diamond Sieve Size'), columns: 1, read_only: 1, reqd: 1, in_list_view: 1, options: "Attribute Value", get_query() { return { query: 'jewellery_erpnext.query.item_attribute_query', filters: { 'item_attribute': 'Diamond Sieve Size' } } } },
            ...
            { fieldtype: 'Float', fieldname: "size_in_mm", label: __('Size (in MM)'), columns: 1, read_only: 1, in_list_view: 1, read_only: 1 },
            { fieldtype: 'Column Break', fieldname: 'clb2' },
            { fieldtype: 'Float', fieldname: "pcs", label: __('Pcs'), reqd: 1, in_list_view: 1, read_only: 1, columns: 1 },
            { fieldtype: 'Float', fieldname: "quantity", label: __('Weight In Cts'), reqd: 1, columns: 1, read_only: 1, in_list_view: 1 },
            ...
            { fieldtype: 'Float', fieldname: "diamond_rate_for_specified_quantity", columns: 1, read_only: 1, label: __('Amount'), in_list_view: 1 },
        ];

        const gemstone_fields = [
            { fieldtype: 'Data', fieldname: "docname", read_only: 1, hidden: 1 },
            { fieldtype: 'Link', fieldname: "gemstone_type", label: __('Gemstone Type'), columns: 1, read_only: 1, reqd: 1, in_list_view: 1, options: "Attribute Value", get_query() { return { query: 'jewellery_erpnext.query.item_attribute_query', filters: { 'item_attribute': 'Gemstone Type' } } } },
            { fieldtype: 'Link', fieldname: "cut_or_cab", label: __('Cut And Cab'), columns: 1, read_only: 1, reqd: 1, in_list_view: 1, options: "Attribute Value", get_query() { return { query: 'jewellery_erpnext.query.item_attribute_query', filters: { 'item_attribute': 'Cut Or Cab' } } } },
            { fieldtype: 'Link', fieldname: "stone_shape", label: __('Stone Shape'), columns: 1, read_only: 1, reqd: 1, in_list_view: 1, options: "Attribute Value", get_query() { return { query: 'jewellery_erpnext.query.item_attribute_query', filters: { 'item_attribute': 'Stone Shape' } } } },
            { fieldtype: 'Column Break', fieldname: 'clb1' },
            { fieldtype: 'Link', fieldname: "gemstone_quality", label: __('Gemstone Quality'), read_only: 1, columns: 1, reqd: 1, in_list_view: 1, options: "Attribute Value", get_query() { return { query: 'jewellery_erpnext.query.item_attribute_query', filters: { 'item_attribute': 'Gemstone Quality' } } } },
            { fieldtype: 'Link', fieldname: "gemstone_size", label: __('Gemstone Size'), columns: 1, read_only: 1, reqd: 1, in_list_view: 1, options: "Attribute Value", get_query() { return { query: 'jewellery_erpnext.query.item_attribute_query', filters: { 'item_attribute': 'Gemstone Size' } } } },
            { fieldtype: 'Link', fieldname: "sub_setting_type", label: __('Sub Setting Type'), columns: 1, read_only: 1, reqd: 1, in_list_view: 1, options: "Attribute Value", get_query() { return { query: 'jewellery_erpnext.query.item_attribute_query', filters: { 'item_attribute': 'Sub Setting Type' } } } },
            { fieldtype: 'Column Break', fieldname: 'clb2' },
            { fieldtype: 'Float', fieldname: "pcs", label: __('Pcs'), columns: 1, reqd: 1, read_only: 1, in_list_view: 1 },
            { fieldtype: 'Float', fieldname: "quantity", label: __('Weight In Cts'), columns: 1, reqd: 1, read_only: 1, in_list_view: 1 },
            { fieldtype: 'Float', fieldname: "total_gemstone_rate", columns: 1, label: __('Total Gemstone Rate'), in_list_view: 1 },
            { fieldtype: 'Float', fieldname: "gemstone_rate_for_specified_quantity", columns: 1, label: __('Amount'), read_only: 1, in_list_view: 1 },
        ]

        const finding_fields = [
            { fieldtype: 'Data', fieldname: "docname", read_only: 1, hidden: 1 },
            { fieldtype: 'Link', fieldname: "metal_type", columns: 1, label: __('Metal Type'), read_only: 1, reqd: 1, in_list_view: 1, options: "Attribute Value", get_query() { return { query: 'jewellery_erpnext.query.item_attribute_query', filters: { 'item_attribute': 'Metal Type' } } } },
            { fieldtype: 'Link', fieldname: "finding_category", columns: 1, label: __('Category'), read_only: 1, reqd: 1, in_list_view: 1, options: "Attribute Value", get_query() { return { query: 'jewellery_erpnext.query.item_attribute_query', filters: { 'item_attribute': 'Finding Category' } } } },
            { fieldtype: 'Link', fieldname: "finding_type", columns: 1, label: __('Type'), reqd: 1, read_only: 1, in_list_view: 1, options: "Attribute Value", get_query() { return { query: 'jewellery_erpnext.query.item_attribute_query', filters: { 'item_attribute': 'Finding Sub-Category' } } } },
            { fieldtype: 'Link', fieldname: "metal_touch", columns: 1, label: __('Metal Touch'), read_only: 1, reqd: 1, in_list_view: 1, options: "Attribute Value", get_query() { return { query: 'jewellery_erpnext.query.item_attribute_query', filters: { 'item_attribute': 'Metal Touch' } } } },
            { fieldtype: 'Link', fieldname: "metal_purity", columns: 1, label: __('Metal Purity'), read_only: 1, reqd: 1, in_list_view: 1, options: "Attribute Value", get_query() { return { query: 'jewellery_erpnext.query.item_attribute_query', filters: { 'item_attribute': 'Metal Purity' } } } },
            { fieldtype: 'Column Break', fieldname: 'clb1' },
            { fieldtype: 'Link', fieldname: "finding_size", columns: 1, label: __('Size'), read_only: 1, reqd: 1, in_list_view: 1, options: "Attribute Value", get_query() { return { query: 'jewellery_erpnext.query.item_attribute_query', filters: { 'item_attribute': 'Finding Size' } } } },
            { fieldtype: 'Link', fieldname: "metal_colour", columns: 1, label: __('Metal Colour'), read_only: 1, reqd: 1, in_list_view: 1, options: "Attribute Value", get_query() { return { query: 'jewellery_erpnext.query.item_attribute_query', filters: { 'item_attribute': 'Metal Colour' } } } },
            { fieldtype: 'Float', fieldname: "quantity", columns: 1, label: __('Quantity'), reqd: 1, read_only: 1, in_list_view: 1, default: 1 },
            { fieldtype: 'Float', fieldname: "rate", columns: 1, label: __('Rate'), reqd: 1, in_list_view: 1, default: 1 },
            { fieldtype: 'Column Break', fieldname: 'clb2' },
            { fieldtype: 'Float', fieldname: "amount", columns: 1, label: __('Amount'), reqd: 1, read_only: 1, in_list_view: 1, default: 1 },
            { fieldtype: 'Float', fieldname: "making_rate", label: __('Making Rate'), reqd: 1, columns: 1, in_list_view: 1 },
            { fieldtype: 'Float', fieldname: "making_amount", label: __('Making Amount'), reqd: 1, read_only: 1, columns: 1, in_list_view: 1 },
        ...
        const other_fields = [
            { fieldtype: 'Data', fieldname: "docname", read_only: 1, hidden: 1 },
            { fieldtype: 'Link', fieldname: "item_code", read_only: 1, options: "Item", columns: 2, in_list_view: 1 },
            { fieldtype: 'Float', fieldname: "weight", read_only: 1, label: __('WT in (GMS)'), columns: 2, in_list_view: 1 },
            { fieldtype: 'Float', fieldname: "qty", read_only: 1, label: __('Qty'), columns: 2, in_list_view: 1 },
            { fieldtype: 'Link', fieldname: "uom", columns: 1, read_only: 1, label: __('UOM'), reqd: 2, in_list_view: 1, options: "UOM" }
        ]
        ...
        const dialog = new frappe.ui.Dialog({
            ...
            fields: [
                    ...
                    onchange: (e) => {
                        ...
                        if (e.target.value) {
                            scan_api_call(e.target.value, (r) => {
                                if (r.message) {
                                    update_dialog_values(row.item_code, r)
                                }
                            })
                        }
                    }
                ...
                },
                {
                    ...
                    onchange: () => {
                        if (dialog.get_value("bom_no")) {
                            edit_bom_documents(dialog, dialog.get_value("bom_no"), metal_data, diamond_data, gemstone_data, finding_data, other_data)
                        }
                    }
                },
                {
                ...
                },
                {
                    ...
                    label: "Sale Key",
                    onchange: ()=>{
                        if (dialog.get_value("sale_key"))dialog.set_value("saleAmount", dialog.get_value("sale_amount")/dialog.get_value("sale_key") || 0)
                    }
                },
                {
                    fieldtype: "Column Break",
        ...
        if (row.bom) {
            edit_bom_documents(dialog, row.bom, metal_data, diamond_data, gemstone_data, finding_data, other_data)
        }

        // setting bom no if missing from child
        if (!dialog.get_value('bom_no') && dialog.get_value('serial_no')) {
            console.log('in else case');
            frappe.db.get_value('BOM', { 'tag_no': dialog.get_value('serial_no'), 'is_active': 1, 'customer': cur_frm.doc.customer }, 'name')
                .then((r) => {
...
let edit_bom_documents = (dialog, bom_no, metal_data, diamond_data, gemstone_data, finding_data, other_data) =>{
    /*
    ...
    */
    ...
    if (!doc){
        frappe.call({
            ...
            callback(r) {
                if(r.message) {
                    set_edit_bom_details(r.message, dialog, metal_data, diamond_data, gemstone_data, finding_data, other_data)
                }
            }
        });
    } else {
...
let set_edit_bom_details = (doc, dialog, metal_data, diamond_data, gemstone_data, finding_data, other_data) => {
    /*
    ...
    */
    ...
    if (dialog.get_value("sale_key"))dialog.set_value("saleAmount", dialog.get_value("sale_amount")/dialog.get_value("sale_key"))
}
...
function update_dialog_values(scanned_item, r) {
